 ...
 *
 * Приемы для достижения параллелььности : разделение блокировки , распределение блокировки и контроль параллельности без блокировки .
 *
 * Если классы или статические методы связаны с изменяемыми статическими полями , то должна быть внутренняя синхронизация,
 * даже если обычно применяются только с одним потоком. В противоположность совместно используемому экземпляру - здесь клиент
 ...
 *
 * Никогда не вызывайте чужые методы из синхронизируемой области.
 */
public class Item67
{
