...
public class Item41
{
    ...
    //Выбор перегружаемых методов является статичным, тогда как выбор переопределяемых методов - динамическим.
    public static void main(String[] args) {
        ...
        //Безопасная, умеренная политика предписывает никогда не предоставлять два варианта перезагрузки с одним и
...
//Ошибка, которую выведет данная программа
