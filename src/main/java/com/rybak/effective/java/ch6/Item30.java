...
/**
 * Испльзуйте перечислимые типы вместо констант int
 *
 ...
 *
 * Перечислимые типы в java - яляются класами , которые экспортируют идин экзумпляр каждой перечислимой константы ,
 ...
 *
 *
 * Перечислимые типы в Java явялются классами, которые экспортируют один экземляр каждой перечислимой константы,
 * испльзуя открытое статичексое завершоное поле.
 */
public class Item30
{
...
//TODO Для ассоциации данных с перечеслимыми константами объявите поля экземпляра и напишите конструктор,
...
//Перечислимый тип , переключающийся на свое собственое значение - не очень !!!
enum Operation
{
...
//Перечислимый тип с реализацией метода в зависимости от констатны
...
//Перечислимый тип , переключающися на свое значение , чтобы сделать код общим  - спорно
enum PayrollDay
{
    MONDAY,
    TUESDAY,
...
//TODO Переключение на перечислимых типах хорошо подходит для задания аргументов внешних перечислимых типов
